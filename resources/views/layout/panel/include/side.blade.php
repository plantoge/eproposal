    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-6" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_aside_footer, #kt_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0px">
            <div class="d-flex flex-center flex-column mb-10">
                ...
                <span class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1">
                    <span id="namavisi" data-original="{{auth()->user()->name}}">{{auth()->user()->name}}</span>
                    {{-- <button class="btn btn-sm" id="toggleVisibility"><i class="fa fa-eye"></i></button> --}}
                </span>
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('users*') ? 'active' : '' }}" href="{{url('users')}}" data-kt-page="pro">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('role*') ? 'active' : '' }}" href="{{url('role')}}" data-kt-page="pro">
                    <span class="menu-icon">
                        <i class="fas fa-folder fa-lg"></i>
                    </span>
                    <span class="menu-title">Role
                        {{-- <span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></span> --}}
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('permission*') ? 'active' : '' }}" href="{{url('permission')}}" data-kt-page="pro">
                    <span class="menu-icon">
                        <i class="fas fa-folder fa-lg"></i>
                    </span>
                    <span class="menu-title">Permission
                        {{-- <span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></span> --}}
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('assignrole*') ? 'active' : '' }}" href="{{url('assignrole')}}" data-kt-page="pro">
                    <span class="menu-icon">
                        <i class="fas fa-folder fa-lg"></i>
                    </span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('givepermission*') ? 'active' : '' }}" href="{{url('givepermission')}}" data-kt-page="pro">
                    <span class="menu-icon">
                        <i class="fas fa-folder fa-lg"></i>
                    </span>
                    <span class="menu-title">Give Permission
                        {{-- <span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></span> --}}
                    </a>
                </div>
                @endcan
