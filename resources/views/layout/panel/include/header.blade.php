<div id="kt_header" class="header align-items-stretch shadow-sm bg-white" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    <div class="container-xxl d-flex align-items-center">
        <div class="d-flex align-items-center d-lg-none ms-n2 me-3 rounded" title="Show aside menu" style="background-color: #00B9AD !important;">
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="{{url('/panel')}}">
                <img alt="Logo" src="{{url('Twebsite/v1/media/logos/logo-desc.png')}}" class="h-40px h-lg-60px logo-default" />
                <img alt="Logo" src="{{url('Twebsite/v1/media/logos/logo-desc.png')}}" class="h-40px h-lg-60px logo-sticky" />
            </a>
        </div>
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        ...
                        {{-- <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            <span class="menu-link py-3" onclick="window.location.href='#'">
                                <span class="menu-title text-dark">Menu Single</span>
                            </span>
                        </div> --}}
                    </div>
                </div>
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                <div class="topbar d-flex align-items-stretch flex-shrink-0">
                    ...
                    {{-- <div class="d-flex align-items-center ms-1 ms-lg-3">
                        <div class="btn btn-icon bg-dark btn-custom btn-active-light position-relative w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{url('Twebsite/v1/media/patterns/dropdown-header-bg.png')}}')">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                <a href="{{url('/setelan')}}" class="menu-link px-5">
                                    @if (auth()->user()->roles->contains('name', 'operator')) @endif
                    ...
                    <div class="d-flex align-items-center d-lg-none ms-4 rounded" title="Show header menu" style="background-color: #00B9AD !important;">
