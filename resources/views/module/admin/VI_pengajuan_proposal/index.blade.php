                            ...
                            <div class="card-toolbar">
                                @if($data->proposal_tahapan)
                                    <a 
                                        ...
                                        href="{{url('pengajuan-proposal/progress/'.$data->id)}}">
                                ...
                                <table class="table table-sm text-center align-midle nowrap">
                                    ...
                                    <tbody class="table-group-divider">
                                        <tr>
                                            ...
                                            @if($data->proposal_surat_tanggapan != null)
                                            <td>
                                                <a href="{{Storage::url('FILE_SURAT_TANGGAPAN/'.$data->proposal_surat_tanggapan)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a>
                                                {{-- <a href="{{Storage::url('FILE_SURAT_TANGGAPAN/'.$data->proposal_surat_tanggapan)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a> --}}
                                            </td>
                                            @endif
                                            <td>
