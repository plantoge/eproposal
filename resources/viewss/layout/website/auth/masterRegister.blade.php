...
<html lang="en" >
                    ...
                    <form class="form w-100" action="{{url('auth-post-signup')}}" method="post">
                        ...
                        <div class="mb-10 text-center">
                            ...
                            <div class="text-gray-500 fw-semibold fs-4">
                                ...
                                <a href="{{url('login-ulang')}}" class="link-primary fw-bolder">MASUK</a>
                            </div>
                        </div>

                        {{-- <button type="button" class="btn btn-light-primary fw-bold w-100 mb-10">
                            <img alt="Logo" src="{{url('Twebsite/v1/media/svg/brand-logos/google-icon.svg')}}" class="h-20px me-3"/>     
                            Sign in with Google
                        </button> --}}
                        ...
                        <div class="fv-row mb-7">
                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="WhatsApp Ex: 08123456789" name="phone" autocomplete="off" maxlength="16" value="{{old('phone')}}" />
                            @error('phone')
                            <small class="text-danger"><b>{{$message}}</b></small>
                            @enderror
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="Institusi Asal" name="institusi_asal" autocomplete="off" maxlength="16" value="{{old('institusi_asal')}}" />
    ...
    {{-- <script src="{{url('Twebsite/v1/js/custom/authentication/sign-up/general.js')}}"></script> --}}
