        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col col-lg-5 mb-6">
                    <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN_DRAFT/'.$proposal->PROPOSAL_IZIN_PENELITIAN_DRAFT)}}" class="card hover-elevate-up shadow-sm parent-hover" target="_blank">
