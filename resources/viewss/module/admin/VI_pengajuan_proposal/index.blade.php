                        ...
                        <div class="card-body">
                                ...
                                @if($data->PROPOSAL_STATUS == 'Penjadwalan Presentasi')
                                    ...
                                    @else 
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            Presentasi dijadwalkan pada {{\Carbon\Carbon::parse($data->PROPOSAL_TANGGAL_PRESENTASI)->format('d/m/Y')}} pukul {{\Carbon\Carbon::parse($data->PROPOSAL_TANGGAL_PRESENTASI)->format('H:i')}} secara {{$data->PROPOSAL_KATEGORI_PRESENTASI}} @if($data->PROPOSAL_KATEGORI_PRESENTASI == 'Daring') (Mohon untuk menyiapkan Slide PPT). <a href="{{$data->PROPOSAL_MEDIA_PRESENTASI}}" class="btn btn-link btn-sm" target="_blank">Klik disini</a> @else di {{$data->PROPOSAL_MEDIA_PRESENTASI}} (Mohon untuk menyiapkan Slide PPT). @endif
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                    @endif
                            ...
                            @elseif($data->PROPOSAL_TAHAPAN == '5')
                                ...
                                @if($data->PROPOSAL_LAPORAN_PENELITIAN == null || $data->PROPOSAL_RAW_DATA_PENELITIAN == null)
                                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                        <strong>Info!</strong> Silahkan upload Laporan Penelitian dan Raw Data untuk mendapatkan Surat Izin Penelitian Resmi dari RSPI Prof. Dr. Sulianti Saroso
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                @endif
                                ...
                                <table class="table table-sm text-center align-midle nowrap">
                                    <thead>
                                        <tr class="fw-bold fs-6 text-gray-800">
                                            ...
                                            @endif
                                            @if($data->PROPOSAL_SURAT_TANGGAPAN != null)
                                    ...
                                    <tbody class="table-group-divider">
                                        <tr>
                                            ...
                                            @if($data->PROPOSAL_SURAT_PENOLAKAN != null)
                                            <td>
                                                <a href="{{asset('/storage/FILE_SURAT_PENOLAKAN/'.$data->PROPOSAL_SURAT_PENOLAKAN)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a>
                                            </td>
                                            @endif
                                            @if($data->PROPOSAL_SURAT_TANGGAPAN != null)
                                            <td>
                                                <a href="{{asset('/storage/FILE_SURAT_TANGGAPAN/'.$data->PROPOSAL_SURAT_TANGGAPAN)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a>
                                                {{-- <a href="{{asset('/storage/FILE_SURAT_TANGGAPAN/'.$data->PROPOSAL_SURAT_TANGGAPAN)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a> --}}
                                            </td>
                                            @endif
                                            <td>
                                                @if($data->PROPOSAL_SURAT_PENGANTAR)
                                                <a href="{{asset('/storage/FILE_SURAT_PENGANTAR/'.$data->PROPOSAL_SURAT_PENGANTAR)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                            ...
                                            <td>
                                                @if($data->PROPOSAL_PROPOSAL_PENELITIAN)
                                                    ...
                                                    {{-- <a href="{{asset('/storage/FILE_PROPOSAL_PENELITIAN/'.$data->PROPOSAL_PROPOSAL_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a> --}}
                                                @else
                                                    <button class="btn btn-link btn-sm disabled">Kosong</button>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_KAJI_ETIK/'.$data->PROPOSAL_KAJI_ETIK)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <button class="btn btn-link btn-sm disabled">Kosong</button>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_PKS/'.$data->PROPOSAL_PKS)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                            ...
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_MTA/'.$data->PROPOSAL_MTA)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <span class="btn btn-link btn-sm disabled">Kosong</span>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_KERAHASIAAN/'.$data->PROPOSAL_KERAHASIAAN)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <button class="btn btn-link btn-sm disabled">Kosong</button>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_SERTIFIKAT_GCP/'.$data->PROPOSAL_SERTIFIKAT_GCP)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <button class="btn btn-link btn-sm disabled">Kosong</button>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_KAJI_ETIK_RSPI/'.$data->PROPOSAL_KAJI_ETIK_RSPI)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <span class="btn btn-link btn-sm disabled">Kosong</span>
                                                @endif
                                            </td>
                                            @if($data->PROPOSAL_IZIN_PENELITIAN_DRAFT != null)
                                            <td>
                                                <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN_DRAFT/'.$data->PROPOSAL_IZIN_PENELITIAN_DRAFT)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a>
                                            </td>
                                            @endif
                                            @if($data->PROPOSAL_IZIN_PENELITIAN != null)
                                            <td>
                                                <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN/'.$data->PROPOSAL_IZIN_PENELITIAN)}}" target="_blank" class="btn btn-link text-danger btn-sm blinking">Lihat</a>
                                            </td>
                                            @endif
                                            {{-- <td>
                                                @if($data->PROPOSAL_BUKTI_BAYAR)
                                                <a href="{{asset('/storage/FILE_BUKTI_BAYAR/'.$data->PROPOSAL_BUKTI_BAYAR)}}" target="_blank" class="btn btn-link btn-sm">bukti bayar</a>
                                                @else
                                                    <span class="btn btn-link btn-sm disabled">Kosong</span>
                                                @endif
                                            </td> --}}
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_LAPORAN_PENELITIAN/'.$data->PROPOSAL_LAPORAN_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <button class="btn btn-link btn-sm disabled">Kosong</button>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a href="{{asset('/storage/FILE_RAW_DATA_PENELITIAN/'.$data->PROPOSAL_RAW_DATA_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <button class="btn btn-link btn-sm disabled">Kosong</button>
                                                @endif
                                            </td>
                        ...
                        <div class="card-footer" style="padding: 0.5rem !important;">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <span class="float-lg-start fw-bold">Pengajuan proposal: {{\Carbon\Carbon::parse($data->created_at)->format('d/m/Y H:i:s')}} WIB</span>
                                </div>
                                <div class="col-sm-6 col-lg-6">
                                    <span class="float-lg-end fw-bold">
                                        ...
                                        @else
                                            Status: <span class="badge badge-danger blinking">{{$data->PROPOSAL_STATUS}}</span>
                                        @endif 
                                    </span>
                                </div>
