                        ...
                        <tbody>
                            ...
                            <tr class="align-middle border-secondary border-bottom">
                                ...
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_LAPORAN_PENELITIAN/'.$data->PROPOSAL_LAPORAN_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm text-danger">laporan penelitian</a>
                                    @else
                                        <button class="btn btn-link btn-sm">Kosong</button>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_RAW_DATA_PENELITIAN/'.$data->PROPOSAL_RAW_DATA_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm text-danger">raw data</a>
                                    @else
                                        <button class="btn btn-link btn-sm">Kosong</button>
                                    @endif
                                </td>
