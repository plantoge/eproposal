                        ...
                        <tbody>
                            ...
                            <tr class="align-middle border-secondary border-bottom">
                                ...
                                <td>
                                    ...
                                    <button class="w-100 btn btn-sm btn-danger text-white btn-delete-pengajuan disabled" hidden data-pengajuan="{{$data->PROPOSAL_ID}}">
                                        Batalkan
                                    </button>
                                    <button 
                                ...
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_SURAT_PENGANTAR/'.$data->PROPOSAL_SURAT_PENGANTAR)}}" target="_blank" class="btn btn-link btn-sm text-danger">surat pengantar</a>
                                    @else
                                ...
                                <td>
                                    ...
                                    {{-- <a href="{{asset('/storage/FILE_PROPOSAL_PENELITIAN/'.$data->PROPOSAL_PROPOSAL_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm text-danger">proposal penelitian</a> --}}
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_KAJI_ETIK/'.$data->PROPOSAL_KAJI_ETIK)}}" target="_blank" class="btn btn-link btn-sm text-danger">kaji etik</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_SERTIFIKAT_GCP/'.$data->PROPOSAL_SERTIFIKAT_GCP)}}" target="_blank" class="btn btn-link btn-sm text-danger">gcp</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_KAJI_ETIK_RSPI/'.$data->PROPOSAL_KAJI_ETIK_RSPI)}}" target="_blank" class="btn btn-link btn-sm text-danger">kaji etik rspi</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_PKS/'.$data->PROPOSAL_PKS)}}" target="_blank" class="btn btn-link btn-sm text-danger">pks</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_MTA/'.$data->PROPOSAL_MTA)}}" target="_blank" class="btn btn-link btn-sm text-danger">mta</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_SURAT_PENOLAKAN/'.$data->PROPOSAL_SURAT_PENOLAKAN)}}" target="_blank" class="btn btn-link btn-sm text-danger">penolakan</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_BUKTI_BAYAR/'.$data->PROPOSAL_BUKTI_BAYAR)}}" target="_blank" class="btn btn-link btn-sm text-danger">bukti bayar</a>
                                    @else
                                        <span class="btn btn-link btn-sm disabled">Kosong</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN_DRAFT/'.$data->PROPOSAL_IZIN_PENELITIAN_DRAFT)}}" target="_blank" class="btn btn-link btn-sm text-danger">Draft Izin Penelitian</a>
                                    @else
                                        <button class="btn btn-link btn-sm disabled">Kosong</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN/'.$data->PROPOSAL_IZIN_PENELITIAN)}}" target="_blank" class="btn btn-link btn-sm text-danger">Izin Penelitian</a>
                                    @else
                                        <button class="btn btn-link btn-sm disabled">Kosong</button>
                                    @endif
                                </td>
            ...
            <form id="formizin" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-5 fv-row fv-plugins-icon-container">
                        ...
                        <input type="text" value="" id="pengajuannn" name="pengajuannn" hidden>
