                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_SURAT_PENGANTAR)
                                        <a href="{{asset('/storage/FILE_SURAT_PENGANTAR/'.$data->PROPOSAL_SURAT_PENGANTAR)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_SURAT_PENGANTAR}}</a>  
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_PROPOSAL_PENELITIAN) 
                                        <a href="{{asset('/storage/FILE_PROPOSAL_PENELITIAN/'.$data->PROPOSAL_PROPOSAL_PENELITIAN)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_PROPOSAL_PENELITIAN}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_KAJI_ETIK) 
                                        <a href="{{asset('/storage/FILE_KAJI_ETIK/'.$data->PROPOSAL_KAJI_ETIK)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_KAJI_ETIK}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_SERTIFIKAT_GCP) 
                                        <a href="{{asset('/storage/FILE_SERTIFIKAT_GCP/'.$data->PROPOSAL_SERTIFIKAT_GCP)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_SERTIFIKAT_GCP}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_KAJI_ETIK_RSPI) 
                                        <a href="{{asset('/storage/FILE_KAJI_ETIK_RSPI/'.$data->PROPOSAL_KAJI_ETIK_RSPI)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_KAJI_ETIK_RSPI}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_PKS) 
                                        <a href="{{asset('/storage/FILE_PKS/'.$data->PROPOSAL_PKS)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_PKS}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_MTA) 
                                        <a href="{{asset('/storage/FILE_MTA/'.$data->PROPOSAL_MTA)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_MTA}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_KERAHASIAAN) 
                                        <a href="{{asset('/storage/FILE_KERAHASIAAN/'.$data->PROPOSAL_KERAHASIAAN)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_KERAHASIAAN}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_BUKTI_BAYAR) 
                                        <a href="{{asset('/storage/FILE_BUKTI_BAYAR/'.$data->PROPOSAL_BUKTI_BAYAR)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_BUKTI_BAYAR}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_IZIN_PENELITIAN_DRAFT) 
                                        <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN_DRAFT/'.$data->PROPOSAL_IZIN_PENELITIAN_DRAFT)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_IZIN_PENELITIAN_DRAFT}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_IZIN_PENELITIAN) 
                                        <a href="{{asset('/storage/FILE_SURAT_IZIN_PENELITIAN/'.$data->PROPOSAL_IZIN_PENELITIAN)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_IZIN_PENELITIAN}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_LAPORAN_PENELITIAN) 
                                        <a href="{{asset('/storage/FILE_LAPORAN_PENELITIAN/'.$data->PROPOSAL_LAPORAN_PENELITIAN)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_LAPORAN_PENELITIAN}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->PROPOSAL_RAW_DATA_PENELITIAN) 
                                        <a href="{{asset('/storage/FILE_RAW_DATA_PENELITIAN/'.$data->PROPOSAL_RAW_DATA_PENELITIAN)}}" target="_blank" class="text-dark">{{$data->PROPOSAL_RAW_DATA_PENELITIAN}}</a> 
                                    @else 
                                        - 
                                    @endif
                                </td>
