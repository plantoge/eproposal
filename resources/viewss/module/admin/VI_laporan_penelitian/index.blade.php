                                        ...
                                        <tr>
                                            <td>
                                                @if($data->PENELITIAN_LAPORAN)
                                                    <a href="{{asset('/storage/FILE_LAPORAN_PENELITIAN/'.$data->PENELITIAN_LAPORAN)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                    {{-- <br>
                                            ...
                                            <td>
                                                @if($data->PENELITIAN_RAW_DATA)
                                                    <a href="{{asset('/storage/FILE_RAW_DATA_PENELITIAN/'.$data->PENELITIAN_RAW_DATA)}}" target="_blank" class="btn btn-link btn-sm">Lihat</a>
                                                @else
                                                    <button class="btn btn-link btn-sm">Kosong</button>
                                                @endif
                                            </td>
                                            <td>
                                                @if($data->PENELITIAN_LAPORAN && $data->PENELITIAN_RAW_DATA)
                                                    @if($data->PENELITIAN_SURAT_IZIN)
                                                        <a href="{{url('storage/app/FILE_SURAT_IZIN_PENELITIAN/'.$data->PENELITIAN_SURAT_IZIN)}}" class="btn btn-link btn-sm blinking text-danger fw-bold" target="_blank">Download</a>
                                                        @else
